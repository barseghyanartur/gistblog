...
try:
    ...
    version = gistblog.__version__
    project = gistblog.__title__
    copyright = gistblog.__copyright__
    author = gistblog.__author__
except ImportError:
    version = "0.1"
    project = "gistblog"
...
epub_identifier = "https://github.com/barseghyanartur/gist-blog"  # URL or ISBN
epub_scheme = "URL"  # or "ISBN"
epub_uid = "https://github.com/barseghyanartur/gist-blog"
